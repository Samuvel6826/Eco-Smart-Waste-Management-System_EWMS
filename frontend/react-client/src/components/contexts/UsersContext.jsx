...
import { usePushNotificationsHook } from './PushNotificationsContext';
...
// Custom hook for using the Users context
export function useUsersHook() {
    const context = useContext(UsersContext);
    if (!context) {
        throw new Error('useUsersHook must be used within a UsersProvider');
    }
    return context;
}
